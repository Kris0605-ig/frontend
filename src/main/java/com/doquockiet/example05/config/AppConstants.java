...
public class AppConstants {
    ...
    public static final String[] PUBLIC_URLS = { "/v3/api-docs/**", "/swagger-ui/**",  "/api/register/**",
            "/api/login","/admin/public/products/image/**", "/api/public/carts/**" ,    "/api/public/**"   // ✅ Mở toàn bộ API public (sản phẩm, ảnh, tìm kiếm,...)
};
            // public static final String[] PUBLIC_URLS = { "/v3/api-docs/**", "/swagger-ui/**",  "/api/register/**",
            // "/api/login","/admin/public/products/image/**", "/api/public/carts/**" };
