...
public UserDTO registerUser(UserDTO userDTO) {
    ...
    // Hàm bổ trợ (Helper method) để tránh lặp lại code xử lý địa chỉ
    ...
    // Các hàm khác giữ nguyên logic nhưng có thể tối ưu bằng ModelMapper...
    @Override
    ...
    public UserDTO updateAddressOfUser(Long userId, Long addressId, AddressDTO ad) {
        ...
        modelMapper.map(ad, address); // Cập nhật nhanh các trường từ DTO sang Entity hiện có
        address.setAddressId(addressId); // Đảm bảo ID không bị thay đổi
